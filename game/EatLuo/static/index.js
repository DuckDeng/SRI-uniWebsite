...
//   var comments = {
//     1: ["【等级I】你们的水平也太差啦！", "【等级I】没有找到差异性！", "【等级I】你这是搞不好滴！"],
...
//     6: ["【非人类】zu一题，得一法，废一类", "【非人类】飘飘然飘飘然", "【非人类】21天就要养成习惯到啦1"]
//   };
...
// }
  ...
  w.replayBtn = function () {
    gameRestart();
    hideGameScoreLayer();
    document.getElementById("demo").innerHTML = "我来把这次的分数来点评一下";
  };
  ...
  function shareText(cps) {
    ...
    var score = 25;
    if (score >= 10) return I18N["text-level-1"];
    if (score >= 20) return I18N["text-level-2"];
    if (score >= 75) return I18N["text-level-3"];
    if (score >= 95) return I18N["text-level-4"];
